...
// CONSTRUCTORS
tcp_server_t::tcp_server_t(boost::asio::io_context& io_context, uint32_t id, std::function<void(boost::asio::ip::tcp::socket*)> connection_callback)
...
void tcp_server_t::async_accept()
{
    ...
    tcp_server_t::m_socket = new boost::asio::ip::tcp::socket(tcp_server_t::m_acceptor.get_executor());

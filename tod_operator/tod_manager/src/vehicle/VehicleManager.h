...
public:
    VehicleManager(const std::string& pathToYamlFile,
    ...
    void callback_control_command_data(const tod_msgs::ControlCmd &control_command_msg);
    ...
    void set_vehicle_part_of_its_pvd_msg(const tod_msgs::PVD_data& msg);

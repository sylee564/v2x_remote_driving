...
using namespace v2x_interface;

// CONSTRUCTORS
udp_socket_t::udp_socket_t(boost::asio::io_context& io_context, uint32_t id)
...
// CONTROL
bool udp_socket_t::open(tcpip_msgs::endpoint& local_endpoint)
{
    ...
    // Create RX publisher.
    udp_socket_t::m_publisher_rx = private_node.advertise<tcpip_msgs::udp_packet>(topic_base + "/rx", 100);
...
// PROPERTIES
tcpip_msgs::udp_socket udp_socket_t::description() const
{
    // Create output message.
    tcpip_msgs::udp_socket description;
...
// ROS
void udp_socket_t::subscriber_tx(const tcpip_msgs::udp_packetConstPtr& message)
{
    // Send the data.

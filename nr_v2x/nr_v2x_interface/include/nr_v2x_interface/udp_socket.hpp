...
#include <ros/ros.h>
#include <tcpip_msgs/udp_packet.h>
#include <tcpip_msgs/udp_socket.h>
...
public:
    ...
    /// \param io_context The application's io_context instance.
    /// \param id The unique ID of the UDP socket.
    udp_socket_t(boost::asio::io_context& io_context, uint32_t id);
    ~udp_socket_t();
...
private:
    ...
    void subscriber_tx(const tcpip_msgs::udp_packetConstPtr& message);
};
